...
var _defaults = _interopRequireDefault(__webpack_require__(7));
var _definitions = _interopRequireDefault(__webpack_require__(8));
var _inputmask = _interopRequireDefault(__webpack_require__(9));
var _eventruler = __webpack_require__(14);
...
exports["default"] = void 0;
var _window = _interopRequireDefault(__webpack_require__(10));
var _data = _interopRequireDefault(__webpack_require__(11));
...
var EventHandlers = exports.EventHandlers = {
  keyEvent: function keyEvent(e, checkval, writeOut, strict, ndx) {
    ...
    inputmask.ignorable = c.length > 1 && !(input.tagName.toLowerCase() === "textarea" && c == _keycode.keys.Enter);
  ...
  setValueEvent: function setValueEvent(e) {
    ...
    (0, _inputHandling.applyInputValue)(input, value, new $.Event("input"));
...
function handleRemove(input, c, pos, strict, fromIsValid) {
  ...
  if ((offset = revalidateMask.call(inputmask, pos)) !== false) {
    if (strict !== true && opts.keepStatic !== false || opts.regex !== null && _validationTests.getTest.call(inputmask, pos.begin).match.def.indexOf("|") !== -1) {
      ...
      //         )
      //       : getLastValidPosition.call(inputmask, -1, true);
      // }
    }
        ...
        if (mask !== undefined) {
          ...
          if (dynMatches) {
            ...
            var targetSymbol = match[0][0],
              ndx = match.index;
            while (inputmask && _validationTests.getTest.call(inputmask, ndx).match.placeholder === targetSymbol) {
              ndx++;
            }
...
function getTokenMatch(pos, opts, maskset) {
  var inputmask = this,
    masksetHint = maskset && maskset.tests[pos] ? maskset.tests[pos][0].match.placeholder : "",
    calcPos = 0,
    targetMatch,
    match,
    matchLength = 0;
  ...
  datetime: {
    ...
    postValidation: function postValidation(buffer, pos, c, currentResult, opts, maskset, strict, fromCheckval) {
      ...
      if (tokenMatch.targetMatch && tokenMatch.targetMatch[0] && formatCode[tokenMatch.targetMatch[0]] !== undefined) {
        var fcode = formatcode(tokenMatch.targetMatch);
        validator = fcode[0];
