    ...
    return function() {
        ...
        var e = {
            ...
            219: function(e, t, n) {
                    ...
                    return t = e, (n = [ {
                        ...
                        value: function(e, t, n) {
                            ...
                            for (S(t).lastIndex = 0; i = S(t).exec(this.format); ) {
                                ...
                                if (void 0 !== e) {
                                    if (a) {
                                        var s = S(t).lastIndex, c = T.call(n, i.index, t, n && n.maskset);
                                        S(t).lastIndex = s, o = e.slice(0, e.indexOf(c.nextMatch[0]));
                                    } else {
                ...
                function O(e, t, n, a) {
                    var r, o, l = "", s = 0, c = {};
                    for (S(n).lastIndex = 0; r = S(n).exec(e); ) {
            ...
            7760: function(e, t, n) {
                ...
                function f(e, t, n, i, r) {
                    ...
                    if (v.forEach((function(e, t) {
                        ...
                        var x, P, S = o.seekNext.call(u, -1, void 0, !1);
                        if (!l.isComplete.call(u, o.getBuffer.call(u)) && k.length <= S || l.isComplete.call(u, o.getBuffer.call(u)) && k.length > 0 && k.length !== S && 0 === k[0]) for (var w = S; void 0 !== (x = k.shift()); ) if (x < w) {
                            var O = new h.Event("_checkval");
                            if ((P = f.validPositions[x]).generatedInput = !0, O.key = P.input, (c = a.EventHandlers.keypressEvent.call(u, O, !0, !1, n, w)) && void 0 !== c.pos && c.pos !== x && f.validPositions[c.pos] && !0 === f.validPositions[c.pos].match.static) k.push(c.pos); else if (!c) break;
                            w++;
                        }
                    }
                    ...
                    for (;i = t ? d.exec(e) : p.exec(e); ) {
                        if (a = i[0], t) {
                            switch (a.charAt(0)) {
                              ...
                              case "|":
                                if (0 === m.length) {
                                    var w = x(v.matches);
                                    w.openGroup = !0, m.push(w), v.matches = [], y = !0;
                                }
                            }
                            switch (a) {
                              case "\\d":
                        ...
                        if (h) b(); else switch (a.charAt(0)) {
                          ...
                          case n.quantifiermarker[0]:
                            var O = new o.default(!1, !1, !0), M = (a = a.replace(/[{}?]/g, "")).split("|"), _ = M[0].split(","), E = isNaN(_[0]) ? _[0] : parseInt(_[0]), T = 1 === _.length ? E : isNaN(_[1]) ? _[1] : parseInt(_[1]), j = isNaN(M[1]) ? M[1] : parseInt(M[1]);
                            "*" !== E && "+" !== E || (E = "*" === T ? 0 : 1), O.quantifier = {
                                min: E,
                                max: T,
                                jit: j
                            };
                            ...
                            if (h === e && void 0 === r.matches) {
                                ...
                                if (r.isAlternator) return function() {
                                    ...
                                    if (-1 === M || "string" == typeof M) {
                                        ...
                                        if ("string" == typeof M) j = M.split(","); else for (_ = 0; _ < v.matches.length; _++) j.push(_.toString());
                                        ...
                                        for (var B = 0; B < j.length; B++) {
                                            _ = parseInt(j[B]), m = [], n = "string" == typeof M && P(h, _, x) || T.slice();
                                            var I = v.matches[_];
                                            if (I && f(I, [ _ ].concat(l), p)) r = !0; else if (0 === B && (k = i(v)), I && I.matches && I.matches.length > v.matches[0].matches.length) break;
                                            a = m.slice(), h = E, m = [];
                                            for (var F = 0; F < a.length; F++) {
                                                var R = a[F], N = !1;
                                                R.alternation = R.alternation || x, w(R);
                                                for (var V = 0; V < y.length; V++) {
                                                    var G = y[V];
                                                    if ("string" != typeof M || void 0 !== R.alternation && j.includes(R.locator[R.alternation].toString())) {
                                                        if (R.match.nativeDef === G.match.nativeDef) {
                                                            N = !0, w(G, R);
                                                            break;
                                                        }
                                                        if (d(R, G, c)) {
                                                            w(R, G) && (N = !0, y.splice(y.indexOf(G), 0, R));
                                                            break;
                                                        }
                                                        if (d(G, R, c)) {
                                                            w(G, R);
                                                        ...
                                                        if (S(R, G)) {
                                                            O(R, G) || void 0 !== u.inputmask.userOptions.keepStatic ? w(R, G) && (N = !0, y.splice(y.indexOf(G), 0, R)) : c.keepStatic = !0;
                                                            break;
                                                        }
                                                        if (S(G, R)) {
                                                            w(G, R);
            ...
            7215: function(e, t, n) {
                ...
                function l(e, t, n, i, a, s) {
                    ...
                    var h, v, m, g, y, k, b, x, P, S, w, O = u.extend(!0, [], d.validPositions), M = u.extend(!0, {}, d.tests), _ = !1, E = !1, T = void 0 !== a ? a : r.getLastValidPosition.call(c);
                    if (s && (S = s.begin, w = s.end, s.begin > s.end && (S = s.end, w = s.begin)), 
                    -1 === T && void 0 === a) h = 0, v = (g = o.getTest.call(c, h)).alternation; else for (;T >= 0; T--) if ((m = d.validPositions[T]) && void 0 !== m.alternation) {
                        if (T <= (e || 0) && g && g.locator[m.alternation] !== m.locator[m.alternation]) break;
                        h = T, v = d.validPositions[h].alternation, g = m;
                    }
                    if (void 0 !== v) {
                        ...
                        A = j.length - 1), (k = d.validPositions[b]) && !0 !== k.generatedInput && (void 0 === s || y < S || y >= w) && j.push(k.input), 
                ...
                function f(e, t, n, i, a, p, m) {
                    ...
                    !0 === w) {
                        if (w = S(x, t, n), (!n || !0 === i) && !1 === w && !0 !== p) {
                            ...
                            if (!_ || !0 !== _.match.static || _.match.def !== t && t !== k.skipOptionalPartCharacter) {
                                if (k.insertMode || void 0 === b.validPositions[r.seekNext.call(g, x)] || e.end > x) {
                                    ...
                                    E = !0), e.end > x && (b.validPositions[x] = void 0), !E && !r.isMask.call(g, x, k.keepStatic && 0 === x)) for (var T = x + 1, j = r.seekNext.call(g, x, !1, 0 !== x); T <= j; T++) if (!1 !== (w = S(T, t, n))) {
                        ...
                        g.hasAlternator && !0 !== a && !n && (a = !0, !1 === w && k.keepStatic && (c.call(g, r.getBuffer.call(g)) || 0 === x) ? w = l.call(g, x, t, n, i, void 0, e) : (u.call(g, e) && b.tests[x] && b.tests[x].length > 1 && k.keepStatic || 1 == w && !0 !== k.numericInput && b.tests[x] && b.tests[x].length > 1 && r.getLastValidPosition.call(g, void 0, !0) > x) && (w = l.call(g, !0))), 
                        !0 === w && (w = {
                            pos: x
                        });
                    }
